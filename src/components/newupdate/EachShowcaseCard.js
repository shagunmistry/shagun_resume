...
class EachShowcaseCard extends Component {
  render() {
    const { logoLinks, responsibilities, subtitle, title } = this.props;
    ...
    return (
      <div className="card showcaseCard">
        <div className="card-block">
          ...
          <h4 role="button" data-toggle="collapse" href={"#" + collapseId}>
            <a href={logoLinks}>{title}</a>{" "}
